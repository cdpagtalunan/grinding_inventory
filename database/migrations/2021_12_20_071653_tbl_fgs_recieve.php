...
class TblFgsRecieve extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_fgs_recieve', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('fk_fgs_id')->unsigned();
            $table->string('PR_number')->nullable();
            $table->string('GR_number')->nullable();
            $table->bigInteger('fgs_IN')->default(0);
            $table->bigInteger('fgs_OUT')->default(0);
